...
export class PaymentInformationPage extends BaseApp {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public toolTipService: TooltipServiceProvider,
    public paymentService: PaymentServiceProvider, public injector: Injector
  ) {
    super(injector);
