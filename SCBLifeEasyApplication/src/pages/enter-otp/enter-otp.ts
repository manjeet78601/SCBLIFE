...
export class EnterOtpPage extends BaseApp {
  ...
  constructor(
    ...
    // try again message
    this.translateService.get("login.pleaseTryAgain").subscribe((data: any) => {
      this.tryAgainMessage = data;
    });
    this.translateService.get("login.defaultErrorMessage").subscribe((data: any) => {
      this.defaultErrorMessage = data;
    });
