  ...
  [self.commandDelegate runInBackground:^{
    ...
    if ([laContext canEvaluatePolicy:LAPolicyDeviceOwnerAuthenticationWithBiometrics error:&error]) {
      ...
      NSArray *errorKeys = @[@"code", @"localizedDescription"];
        NSMutableDictionary *errorKeysDict = [NSMutableDictionary dictionaryWithDictionary:[error dictionaryWithValuesForKeys:errorKeys]];
        [errorKeysDict setValue:biometryType forKey:@"biometryType"];
        [self.commandDelegate sendPluginResult:[CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR messageAsDictionary:errorKeysDict]
                                  callbackId:command.callbackId];
    }
  }];
}
